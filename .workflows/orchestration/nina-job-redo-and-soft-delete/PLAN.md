...
|---|-------|-----------|---------|-------|-----------|------------|------|--------|------|
| 1 ✅ | Redo: reopen a failed job from its own args | R1 | `lib/nina` + `components/nina` + `app/nina/jobs` | 8 | — | NORMAL | `.workflows/plan/nina-job-redo-and-soft-delete/phase-1.md` | `P1-NIN-A015` | `miftahulmahfuzh/run-insights#105` |
