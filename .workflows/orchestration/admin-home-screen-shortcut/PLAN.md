...
|---|-------|-----------|---------|-------|-----------|------------|------|--------|------|
| 1 ✅ | The second manifest: `/admin` starts at `/admin` | R1, R2 | `app/admin` + `lib` | 4 | — | NORMAL | `.workflows/plan/admin-home-screen-shortcut/phase-1.md` | `P1-RI-A021` | `miftahulmahfuzh/run-insights#109` |
| 2 ✅ | A tile you can tell apart: the admin icon set | R1 | `tools` + `app/admin` + `public/icons` | 10 | 1 | NORMAL | `.workflows/plan/admin-home-screen-shortcut/phase-2.md` | `P1-RI-A022` | `miftahulmahfuzh/run-insights#110` |
