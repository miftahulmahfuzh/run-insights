...
|---|-------|-----------|---------|-------|-----------|------------|------|--------|------|
| 1 | The panel pins the window over its focused field | R1 | `components/nina` | 1 | — | HARD | `.workflows/plan/search-kbd-and-up-btn/phase-1.md` | — | — |
| 2 | The rail's `up` reveals the main bar | R2 | `components/nina` + `components/ui` + `lib/nina` + `tests` | 7 | 1 | HARD | `.workflows/plan/search-kbd-and-up-btn/phase-2.md` | — | — |
