...
|---|-------|-----------|---------|-------|-----------|------------|------|--------|------|
| 1 | Error-log schema + writer/reader | R1, R2 | `lib/db`, `lib/nina` | 7 | — | NORMAL | `.workflows/plan/nina-llm-fallback-error-logs/phase-1.md` | — | — |
| 2 | OpenRouter fallback — text chat | R1 | `lib/nina` | 4 | 1, 3 | HARD | `.workflows/plan/nina-llm-fallback-error-logs/phase-2.md` | — | — |
| 3 | OpenRouter fallback — vision/multimodal | R1 | `lib/nina` | 3 | 1 | NORMAL | `.workflows/plan/nina-llm-fallback-error-logs/phase-3.md` | — | — |
| 4 | Image-generation error logging | R2 | `lib/nina` | 5 | 1 | NORMAL | `.workflows/plan/nina-llm-fallback-error-logs/phase-4.md` | — | — |
| 5 | Admin Error Logs page | R2 | `app/admin`, `components/admin`, `lib/admin` | 9 | 1 | HARD | `.workflows/plan/nina-llm-fallback-error-logs/phase-5.md` | — | — |
