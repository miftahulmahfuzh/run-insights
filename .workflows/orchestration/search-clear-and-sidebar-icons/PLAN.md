...
|---|-------|-----------|---------|-------|-----------|------------|------|--------|------|
| 1 | The keyboard stops eating the sidebar's fields; the search field clears | R1, R2 | `components/nina` + `lib/nina` | 4 | — | HARD | `.workflows/plan/search-clear-and-sidebar-icons/phase-1.md` | — | — |
| 2 | Session actions become icons; the rename field clears | R3, R4 | `components/nina` | 1 | — | NORMAL | `.workflows/plan/search-clear-and-sidebar-icons/phase-2.md` | — | — |
| 3 | The sidebar's bottom icon rail | R5 | `components/nina` | 2 | 1 | NORMAL | `.workflows/plan/search-clear-and-sidebar-icons/phase-3.md` | — | — |
