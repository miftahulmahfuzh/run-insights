...
|---|-------|-----------|---------|-------|-----------|------------|------|--------|------|
| 1 | The tuning model and its row | R1, R2, R3 | `lib/nina`, `lib/db`, `drizzle` | 8 | — | NORMAL | `.workflows/plan/nina-character-tuning/phase-1.md` | — | — |
| 2 | The canon, re-cut as a function — and the repeal | R2, R3, R4, R6 | `lib/nina`, `docs` | 2 | 1 | HARD | `.workflows/plan/nina-character-tuning/phase-2.md` | — | — |
| 3 | `buildNinaSystemPrompt`, and the turn that reads it | R3, R4, R6 | `lib/nina`, `lib/nina/prompts`, `tests` | 11 | 1, 2 | HARD | `.workflows/plan/nina-character-tuning/phase-3.md` | — | — |
| 4 | The camera, and a promise she keeps in the chat | R5 | `lib/nina`, `lib/db` | 10 | 1, 2 | HARD | `.workflows/plan/nina-character-tuning/phase-4.md` | — | — |
| 5 | The panel on `/admin/nina` | R1, R2, R3 | `components/admin`, `lib/admin`, `app/admin` | 8 | 1, 3 | NORMAL | `.workflows/plan/nina-character-tuning/phase-5.md` | — | — |
| 6 | The sweep, and the record | R6 | `docs`, `tests`, `lib/nina/prompts` | 9 | 2, 3, 4, 5 | EASY | `.workflows/plan/nina-character-tuning/phase-6.md` | — | — |
