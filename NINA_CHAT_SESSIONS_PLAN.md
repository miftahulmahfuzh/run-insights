...
**Phases:** 9
**Status:** in progress — 2 of 9 phases complete (phases 1, 2); a phase is complete when its row in the Phases table is ticked ✅, which is the authoritative per-phase record because the phases land in parallel; the set is reviewed and merged as a whole
