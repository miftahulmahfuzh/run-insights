...
|---|-------|-----------|---------|-------|-----------|------------|------|--------|------|
| 1 | The composer: paint to the edge, take less room, frost the glass | R1, R2, R3 | `components/nina` + `lib/nina` + `components/ui` + `tests` | 8 | — | HARD | `.workflows/plan/composer-frost-and-admin-notch/phase-1.md` | — | miftahulmahfuzh/run-insights#133 |
