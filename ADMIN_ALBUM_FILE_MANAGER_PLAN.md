...
| 2 | The pure file-tree library: image filter, path grammar, tree build, upload diff | R1 | `lib/admin`, `tests` | 2 | — | NORMAL | `.workflows/plan/admin-album-file-manager/phase-2.md` | — | `#67` |
