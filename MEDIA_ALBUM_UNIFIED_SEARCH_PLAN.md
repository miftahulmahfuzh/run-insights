...
|---|-------|-----------|---------|-------|-----------|------------|------|--------|------|
| 1 | Schema: media keyword/embedding columns + Album pointer FK | R1, R2, R3 | `lib/db/schema/nina`, `drizzle` | 7 | — | NORMAL | `.workflows/plan/media-album-unified-search/phase-1.md` | — | — |
| 2 | Query/action layer: merged search, media embedding pipeline, link-not-copy promotion, deletion guard | R1, R2, R3 | `lib/nina`, `lib/admin` | 23 | 1 | HARD | `.workflows/plan/media-album-unified-search/phase-2.md` | — | — |
| 3 | UI: Media keyword box, merged search results, pointer-row messaging | R1, R2, R3 | `components/admin/explorer`, `app/admin/nina` | 12 | 1, 2 | NORMAL | `.workflows/plan/media-album-unified-search/phase-3.md` | — | — |
| 4 | Backfill + test coverage | R1, R2, R3 | `app/api/admin/nina`, `scripts`, `tests` | 6 | 1, 2, 3 | NORMAL | `.workflows/plan/media-album-unified-search/phase-4.md` | — | — |
