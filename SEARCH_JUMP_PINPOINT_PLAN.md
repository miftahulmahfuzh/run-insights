...
**Phases:** 1
**Status:** complete — phase 1 of 1 landed at the phase commit; the set is reviewed and merged as a whole
**Coordinator:** —
...
|---|-------|-----------|---------|-------|-----------|------------|------|--------|------|
| 1 ✅ | Search hits deep-link through `?jump=` and the landing survives a same-session soft nav | R1, R2 | `lib/nina` | 5 | — | NORMAL | `.workflows/plan/search-jump-pinpoint/phase-1.md` | P1-NIN-A025 | — |
