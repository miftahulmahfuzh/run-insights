 ...
 * message in the chat". `describeMessageDeletion` (whose message, that the photos go with it, that
 * she stops seeing it, that it cannot be undone) was deleted with the step that showed it —
 * nothing renders it. It is in git history if the overrule is ever reversed.
 */
