 ...
 * override was principled rather than lazy: that control hard-deletes a conversation and its
 * photographs with no undo, whereas a redo costs one generation of a six-a-day cap and produces a
 * photograph the runner asked for. There is nothing here to protect him from.
 *
