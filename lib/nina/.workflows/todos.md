...
- [ ] **P1-NIN-A001** Phase 2: The canon, re-cut as a function — and the repeal
  - **Difficulty**: HARD
  - **Type**: Refactor
...
- [ ] **P1-NIN-A002** Phase 3: `buildNinaSystemPrompt`, and the turn that reads it
  - **Difficulty**: HARD
  - **Type**: Refactor
...
- [ ] **P1-NIN-A003** Phase 4: The camera, and a promise she keeps in the chat
  - **Difficulty**: HARD
  - **Type**: Feature
