...
export const ninaTurns = pgTable(
  'nina_turns',
  {
     ...
     * filters is bounded by the daily cap (`ninaImageDailyCap()`, env-tunable, 100 at this
     * writing) — up to a hundred image rows per user per day at the outside — so sixty
     * rows is well under a day of flat-out use, and the worst case for a runner who hides everything is
