...
|---|-------|-----------|---------|-------|-----------|------------|------|--------|------|
| 1 | Purge the tuning revision mechanism everywhere | R1 | `lib/nina`, `lib/db`, `lib/admin`, `app`, `components`, `tests`, `drizzle` | ~21 | — | NORMAL | `.workflows/plan/simplify-personality-settings/phase-1.md` | — | — |
| 2 | Auto-save the Personality panel | R2 | `components/admin`, `lib/admin`, `tests` | ~8 | 1 | HARD | `.workflows/plan/simplify-personality-settings/phase-2.md` | — | — |
