...
**Phases:** 5
**Status:** phase 1/5 complete (1 ✅) — a phase is complete when its row in the Phases table is ticked ✅, which is the authoritative per-phase record because the phases land in parallel; the set is reviewed and merged as a whole
**Coordinator:** —
